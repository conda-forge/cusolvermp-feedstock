...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/cusolvermp-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cusolvermp-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install cusolvermp
```
...
It is possible to list all of the versions of `cusolvermp` available on your platform:
...
```
pixi search cusolvermp --channel conda-forge
```
